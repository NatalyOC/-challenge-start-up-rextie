        ...
        <div className="col-xs-12 col-md-4 col-lg-4">
          <div className="container-title">
            ...
            <ul class="links">
              ...
              <li><a href="http://e-consultaruc.sunat.gob.pe/cl-ti-itmrconsruc/jcrS00Alias" target="_blank">Libro de Reclamaciones</a></li>
            </ul>
        ...
        <div className="col-xs-12 col-md-4 col-lg-4">
          <div className="container-title">
            ...
            <ul class="links">
              ...
              <li><a href="#" target="_blank">Ricardo Angulo 745, Oficina 402
              Urb. Corpac, San Isidro, Lima, Peru</a></li>
              <li><a href="#" target="_blank">Lunes a Sábado de 9 AM a 6 PM</a></li>
            </ul>
